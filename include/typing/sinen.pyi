...
class RenderTexture:
    def __init__(self): ...
    def create(self, size: Vec2) -> None: ...
...
class Shader:
    def __init__(self): ...
    def load_vertex_shader(self, path: str) -> None: ...
    def load_fragment_shader(self, path: str) -> None: ...
...
class Renderer:
    ...
    @staticmethod
    def begin_pipeline2d(pipe: RenderPipeline2D) -> None: ...
    @staticmethod
    def end_pipeline2d() -> None: ...
    @staticmethod
    def begin_pipeline3d(pipe: RenderPipeline3D) -> None: ...
    @staticmethod
    def end_pipeline3d() -> None: ...
    @staticmethod
    def set_uniform_data(data: UniformData) -> None: ...
    @staticmethod
    def begin_render_texture2d(rt: RenderTexture) -> None: ...
    @staticmethod
    def begin_render_texture3d(rt: RenderTexture) -> None: ...
    @staticmethod
    def end_render_texture() -> None: ...
