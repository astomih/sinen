...
public:
  ...
  GetOpaqueColorBlendAttachmentState() {
    ...
    return VkPipelineColorBlendAttachmentState{
        VK_TRUE, // blendEnable
        VK_BLEND_FACTOR_ONE,
        VK_BLEND_FACTOR_ZERO, // color[Src/Dst] BlendFactor
        VK_BLEND_OP_ADD,
        VK_BLEND_FACTOR_ONE,
        VK_BLEND_FACTOR_ZERO, // alpha[Src/Dst] BlendFactor
        VK_BLEND_OP_ADD,
        colorWriteAll};
  }
  static inline VkPipelineColorBlendAttachmentState
  GetAlphaColorBlendAttachmentState() {
    const auto colorWriteAll =
        VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT |
        VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;
    return VkPipelineColorBlendAttachmentState{
        ...
        VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA, // color[Src/Dst] BlendFactor
        VK_BLEND_OP_ADD,
        VK_BLEND_FACTOR_SRC_ALPHA,
        VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA, // alpha[Src/Dst] BlendFactor
        VK_BLEND_OP_ADD,
        colorWriteAll};
  }

  static inline VkPipelineRasterizationStateCreateInfo
  GetDefaultRasterizerState(VkCullModeFlags cullmode = VK_CULL_MODE_NONE) {
  ...
  GetDefaultDepthStencilState() {
    VkPipelineDepthStencilStateCreateInfo depthStencilCI{
        ...
        {VK_STENCIL_OP_KEEP, VK_STENCIL_OP_KEEP, VK_STENCIL_OP_KEEP,
         VK_COMPARE_OP_NEVER, 0, 0, 0}, // front
        {VK_STENCIL_OP_KEEP, VK_STENCIL_OP_KEEP, VK_STENCIL_OP_KEEP,
         VK_COMPARE_OP_NEVER, 0, 0, 0}, // back
        0.0f,
        0.0f // dpethBounds
    };
    return depthStencilCI;
  }
  static inline VkPipelineInputAssemblyStateCreateInfo GetInputAssembly(
  ...
  static inline VkPipelineMultisampleStateCreateInfo GetNoMultisampleState() {
  ...
  LoadShader(VkDevice device, const char *fileName,
    ...
    VkShaderModuleCreateInfo ci{
        VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO, nullptr, 0, code.size(),
  ...
  static inline void
  DestroyShaderModules(VkDevice device,
  ...
  static inline VkViewport GetViewportFlipped(float width, float height) {
    return VkViewport{0.0f, height, width, height * -1.0f, 0.0f, 1.0f};
  }

  static inline VkWriteDescriptorSet
  PrepareWriteDescriptorSet(VkDescriptorSet descriptorSet, uint32_t dstBinding,
  ...
  CreateRenderPassToRenderTarget(VkDevice device, VkFormat colorFormat,
                                 VkFormat depthFormat) {
    std::array<VkAttachmentDescription, 2> attachments;
    attachments[0] =
  ...
  static inline VkDescriptorSetAllocateInfo
  CreateDescriptorSetAllocateInfo(VkDescriptorPool descriptorPool,
  ...
  static inline VkImageCreateInfo CreateEasyImageCreateInfo(
  ...
  static inline VkWriteDescriptorSet
  CreateWriteDescriptorSet(VkDescriptorSet descriptorSet, uint32_t dstBinding,
                           const VkDescriptorBufferInfo *pUboInfo) {
