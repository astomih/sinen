...
ShaderES::ShaderES() : mShaderProgram(0), mVertexShader(0), mFragShader(0) {}
...
void ShaderES::SetDisable() { glDisable(mShaderProgram); }

bool ShaderES::CompileShader(const std::string &fileName, GLenum shaderType,
                             GLuint &outShader) {
#ifdef ANDROID
...
bool ShaderES::CreateUBO(const GLuint &blockIndex, const size_t &size,
                         const void *data) {
...
void ShaderES::UpdateUBO(const GLuint &blockIndex, const size_t &size,
