...
namespace nen::gl
{
	...
	bool ShaderGL::CreateUBO(const GLuint &blockIndex, const size_t &size, const void *data)
	{
	...
	void ShaderGL::UpdateUBO(const GLuint &blockIndex, const size_t &size, const void *data, const GLsizeiptr &offset)
	{
