...
class Model:
    ...
    def load_box(self) -> None: ...
    def get_bone_uniform_data(self) -> UniformData: ...
...
class UniformData:
    ...
    def change(self, value: float, index: int) -> None: ...

class Shader:
    def __init__(self): ...
    def load_vertex_shader(self, path: str, uniform_count: int) -> None: ...
    def load_fragment_shader(self, path: str, uniform_count: int) -> None: ...
    def compile_and_load_vertex_shader(self, source: str) -> None: ...
    def compile_and_load_fragment_shader(self, source: str) -> None: ...
...
class GraphicsPipeline:
    ...
    def set_enable_depth_test(self, enable: bool) -> None: ...
    def set_enable_instanced(self, enable: bool) -> None: ...
    def set_enable_animation(self, enable: bool) -> None: ...
    def set_enable_tangent(self, enable: bool) -> None: ...
    def build(self) -> None: ...
...
class Physics:
    @staticmethod
    def create_box_collider(transform: Transform, is_dynamic: bool) -> Collider: ...
    @staticmethod
    def create_sphere_collider(
        position: Vec3, radius: float, is_dynamic: bool
    ) -> Collider: ...
    @staticmethod
    ...
    @staticmethod
    def add_collider(collider: Collider, active: bool) -> None: ...

class BuiltinPipelines:
    @staticmethod
    def get_3d() -> GraphicsPipeline: ...
    @staticmethod
    def get_3d_instanced() -> GraphicsPipeline: ...
    @staticmethod
    def get_2d() -> GraphicsPipeline: ...

class Graphics:
    @staticmethod
    def draw3d(draw: Draw3D) -> None: ...
    @staticmethod
    ...
    @staticmethod
    @overload
    def draw_rect(rect: Rect, color: Color, angle: float = 0.0) -> None: ...
    @staticmethod
    @overload
    def draw_text(
    ...
    @overload
    def draw_text(
        text: str, position: Vec2, color: Color, font_size: int, angle: float = 0.0
    ) -> None: ...
    @staticmethod
    @overload
    def draw_text(
        text: str, position: Vec2, color: Color, font_size: int = 16, angle: float = 0.0
    ) -> None: ...
    @staticmethod
    @overload
    def draw_text(
    ...
    @staticmethod
    @overload
    def draw_image(texture: Texture, dest: Rect, angle: float) -> None: ...
    @staticmethod
    @overload
    def draw_image(texture: Texture, dest: Rect, angle: float = 0.0) -> None: ...
    @staticmethod
    def draw_model(model: Model, transform: Transform, material: Material) -> None: ...
    @staticmethod
    def draw_model_instanced(
        model: Model, transforms: list[Transform], material: Material
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def bind_pipeline(pipe: GraphicsPipeline) -> None: ...
    @staticmethod
    def set_uniform_data(binding: int, data: UniformData) -> None: ...
    @staticmethod
    def set_render_target(rt: RenderTexture) -> None: ...
    @staticmethod
    def flush() -> None: ...
    @staticmethod
    def readback_texture(src: RenderTexture, dest: Texture) -> None: ...
