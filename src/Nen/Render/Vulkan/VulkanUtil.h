...
inline VkAttachmentDescription GetAttachmentDescription(
...
inline VkPipelineColorBlendAttachmentState GetAlphaColorBlendAttachmentState() {
  const auto colorWriteAll =
      VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT |
      VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;
  return VkPipelineColorBlendAttachmentState{
...
inline VkPipelineInputAssemblyStateCreateInfo GetInputAssembly(
...
LoadShader(VkDevice device, const char *fileName, VkShaderStageFlagBits stage) {
...
inline VkRenderPass CreateRenderPass(VkDevice device, VkFormat colorFormat,
...
inline VkRenderPass CreateRenderPassToRenderTarget(VkDevice device,
