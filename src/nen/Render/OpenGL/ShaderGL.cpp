...
namespace nen::gl
{
	...
	void ShaderGL::SetColorUniform(const char *name, const Color &color)
	{
		GLuint loc = glGetUniformLocation(mShaderProgram, name);
		glUniform4f(loc, color.r, color.g, color.b, color.a);
	}

	void ShaderGL::SetVector2fUniform(const char *name, const Vector2 &vector)
	{
		GLuint loc = glGetUniformLocation(mShaderProgram, name);
	...
	void ShaderGL::SetVectorUniform(const char *name, const Vector3 &vector)
	{
		GLuint loc = glGetUniformLocation(mShaderProgram, name);
		// Send the vector data
