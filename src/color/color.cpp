...
const color palette::Red = color(1.f, 0.f, 0.f, 1.f);
const color palette::Green = color(0.f, 1.f, 0.f, 1.f);
const color palette::Blue = color(0.f, 0.f, 1.f, 1.f);
const color palette::Yellow = color(1.f, 1.f, 0.f, 1.f);
const color palette::LightYellow = color(1.f, 1.f, 0.88f, 1.f);
